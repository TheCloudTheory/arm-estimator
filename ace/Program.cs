...
public class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        var jsonOutputOption = new Option<bool?>("--generateJsonOutput", "Should generate JSON output");
        ...
        var disableDetailsOption = new Option<bool?>("--disableDetailedMetrics", "Disables reporting of detailed metrics");
        var jsonOutputFilenameOption = new Option<string?>("--jsonOutputFilename", "Sets JSON output filename");
        var htmlOutputOption = new Option<bool?>("--generateHtmlOutput", "Should generate HTML output");
        ...
        var htmlOutputFilenameOption = new Option<string?>("--htmlOutputFilename", "Sets HTML output filename");
        var outputFormatOption = new Option<OutputFormat?>("--outputFormat", "Sets output format");
