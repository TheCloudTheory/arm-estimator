...
namespace arm_estimator_tests.Bicep
{
    internal class VmTests
    {
        ...
        [TestCase("Standard_DC4ads_v5", 356.75d)]
        [TestCase("Standard_DC4as_v5", 323.17000000000002d)]
        ...
        [TestCase("Standard_DC2ads_v5", 189.58000000000001d)]
        [TestCase("Standard_DC8ads_v5", 691.81999999999994d)]
        [TestCase("Standard_DC2as_v5", 172.06d)]
        [TestCase("Standard_DC8as_v5", 624.65999999999997d)]
        ...
        [TestCase("Standard_DC2ads_v5", 88.694000000000017d)]
        [TestCase("Standard_DC2as_v5", 81.978000000000009d)]
        ...
        [Test]
        [TestCase("Basic_A0", 22.739999999999998d)]
        [TestCase("Basic_A1", 29.310000000000002d)]
        [TestCase("Basic_A2", 66.539999999999992d)]
        [TestCase("Basic_A3", 158.51999999999998d)]
        [TestCase("Basic_A4", 307.44d)]
        [TestCase("Standard_A0", 24.199999999999999d)]
        [TestCase("Standard_A1", 53.399999999999999d)]
        [TestCase("Standard_A2", 97.199999999999989d)]
        [TestCase("Standard_A3", 184.79999999999998d)]
        [TestCase("Standard_A4", 360.0d)]
        [TestCase("Standard_A5", 206.70000000000002d)]
        [TestCase("Standard_A6", 403.80000000000007d)]
        [TestCase("Standard_A7", 798.00000000000011d)]
        [TestCase("Standard_A1_v2", 39.530000000000001d)]
        [TestCase("Standard_A2_v2", 73.109999999999999d)]
        [TestCase("Standard_A4_v2", 143.19d)]
        [TestCase("Standard_A8_v2", 289.19000000000005d)]
        [TestCase("Standard_A2m_v2", 100.11999999999999d)]
        [TestCase("Standard_A4m_v2", 199.40000000000001d)]
        [TestCase("Standard_A8m_v2", 408.18000000000006d)]
        [TestCase("Standard_B1s", 30.439999999999998d)]
        [TestCase("Standard_B2s", 56.719999999999999d)]
        [TestCase("Standard_B1ls", 26.059999999999999d)]
        [TestCase("Standard_B1ms", 39.200000000000003d)]
        [TestCase("Standard_B2ms", 91.759999999999991d)]
        [TestCase("Standard_B4ms", 161.84d)]
        [TestCase("Standard_B8ms", 302.0d)]
        [TestCase("Standard_D2a_v4", 93.549999999999997d)]
        [TestCase("Standard_D4a_v4", 177.5d)]
        [TestCase("Standard_D8a_v4", 345.40000000000003d)]
        [TestCase("Standard_D2ads_v5", 112.93000000000001d)]
        [TestCase("Standard_D4ads_v5", 204.18000000000001d)]
        [TestCase("Standard_D8ads_v5", 386.68000000000001d)]
        [TestCase("Standard_D2as_v4", 105.63d)]
        [TestCase("Standard_D4as_v4", 189.58000000000001d)]
        [TestCase("Standard_D8as_v4", 357.48000000000002d)]
        [TestCase("Standard_D2as_v5", 97.599999999999994d)]
        [TestCase("Standard_D4as_v5", 173.52000000000001d)]
        [TestCase("Standard_D8as_v5", 325.36000000000001d)]
        [TestCase("Standard_DC2ads_v5", 122.42000000000002d)]
        [TestCase("Standard_DC4ads_v5", 222.43000000000004d)]
        [TestCase("Standard_DC8ads_v5", 423.18000000000006d)]
        [TestCase("Standard_DC2as_v5", 104.90000000000001d)]
        [TestCase("Standard_DC4as_v5", 188.85000000000002d)]
        [TestCase("Standard_DC8as_v5", 356.02000000000004d)]
        [TestCase("Standard_DC1ds_v3", 120.96000000000001d)]
        [TestCase("Standard_DC2ds_v3", 220.24000000000001d)]
        [TestCase("Standard_DC4ds_v3", 418.80000000000001d)]
        [TestCase("Standard_DC8ds_v3", 815.91999999999996d)]
        [TestCase("Standard_DC1s_v2", 105.63d)]
        [TestCase("Standard_DC2s_v2", 189.58000000000001d)]
        [TestCase("Standard_DC4s_v2", 357.48000000000002d)]
        [TestCase("Standard_DC8s_v2", 671.60000000000002d)]
        [TestCase("Standard_DC1s_v3", 105.63d)]
        [TestCase("Standard_DC2s_v3", 189.58000000000001d)]
        [TestCase("Standard_DC4s_v3", 357.48000000000002d)]
        [TestCase("Standard_DC8s_v3", 693.27999999999997d)]
        [TestCase("Standard_D2d_v4", 108.88d)]
        [TestCase("Standard_D4d_v4", 208.16d)]
        [TestCase("Standard_D8d_v4", 406.72000000000003d)]
        [TestCase("Standard_D2ds_v4", 120.96000000000001d)]
        [TestCase("Standard_D4ds_v4", 220.24000000000001d)]
        [TestCase("Standard_D8ds_v4", 418.80000000000001d)]
        [TestCase("Standard_D2ds_v5", 120.96000000000001d)]
        [TestCase("Standard_D4ds_v5", 220.24000000000001d)]
        [TestCase("Standard_D8ds_v5", 418.80000000000001d)]
        [TestCase("Standard_D2d_v5", 108.88d)]
        [TestCase("Standard_D4d_v5", 208.16d)]
        [TestCase("Standard_D8d_v5", 406.72000000000003d)]
        ...
        [TestCase("Standard_DS2_v2", 120.96000000000001d)]
        [TestCase("Standard_DS3_v2", 220.24000000000001d)]
        [TestCase("Standard_DS4_v2", 418.80000000000001d)]
        [TestCase("Standard_D2s_v3", 109.28d)]
        [TestCase("Standard_D4s_v3", 196.88d)]
        [TestCase("Standard_D8s_v3", 372.07999999999998d)]
        [TestCase("Standard_D2s_v4", 105.63d)]
        [TestCase("Standard_D4s_v4", 189.58000000000001d)]
        [TestCase("Standard_D8s_v4", 357.48000000000002d)]
        [TestCase("Standard_D2s_v5", 105.63d)]
        [TestCase("Standard_D4s_v5", 189.58000000000001d)]
        [TestCase("Standard_D8s_v5", 357.48000000000002d)]
        [TestCase("Standard_D1_v2", 59.167000000000002d)]
        [TestCase("Standard_D2_v2", 108.88d)]
        [TestCase("Standard_D3_v2", 208.16d)]
        [TestCase("Standard_D4_v2", 406.72000000000003d)]
        [TestCase("Standard_D2_v3", 97.199999999999989d)]
        [TestCase("Standard_D4_v3", 184.79999999999998d)]
        [TestCase("Standard_D8_v3", 360.0d)]
        [TestCase("Standard_D2_v4", 93.549999999999997d)]
        [TestCase("Standard_D4_v4", 177.5d)]
        [TestCase("Standard_D8_v4", 345.40000000000003d)]
        [TestCase("Standard_D2_v5", 93.549999999999997d)]
        [TestCase("Standard_D4_v5", 177.5d)]
        [TestCase("Standard_D8_v5", 345.40000000000003d)]
        [Parallelizable(ParallelScope.All)]
        ...
        [TestCase("Standard_A2_v2", 22.009999999999998d)]
        ...
        [TestCase("Standard_D2as_v5", 36.863999999999997d)]
        [TestCase("Standard_DC2ads_v5", 41.754999999999995d)]
        [TestCase("Standard_DC2as_v5", 38.396999999999998d)]
        ...
        [TestCase("Standard_DC2s_v2", 55.259999999999998d)]
        [TestCase("Standard_DC1s_v3", 38.469999999999999d)]
        [TestCase("Standard_DC2s_v3", 55.259999999999998d)]
        ...
        [TestCase("Standard_DS2_v2", 41.390000000000001d)]
        [TestCase("Standard_D2s_v3", 39.200000000000003d)]
        [TestCase("Standard_D2s_v4", 38.469999999999999d)]
        [TestCase("Standard_D2s_v5", 38.469999999999999d)]
        [TestCase("Standard_D1_v2", 19.527999999999999d)]
        [TestCase("Standard_D2_v2", 29.310000000000002d)]
