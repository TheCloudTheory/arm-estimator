...
namespace arm_estimator_tests
{
    public class Generic_Bicep_Tests
    {
        ...
        [TestCase("Standard_D2s_v5", 151.11d)]
        [TestCase("Standard_D4s_v5", 302.22d)]
        ...
        [TestCase("Standard_DC2ds_v3", 194.18d)]
        [TestCase("Standard_DC4ds_v3", 388.36d)]
        [TestCase("Standard_DC8ds_v3", 776.72d)]
