...
namespace arm_estimator_tests
{
    public class Generic_ARM_Tests
    {
        ...
        [Test]
        [TestCase("templates/acr.json", 77.060600000000008d, 77.060600000000008d)]
        ...
        [TestCase("templates/automation.json", 5.2320000000000002d, 5.2320000000000002d)]
        ...
        public async Task AksResourceEstimation_ShouldBeCalculatedCorrectly()
        {
            ...
            Assert.That(output, Is.Not.Null);
            Assert.That(output.TotalCost.OriginalValue, Is.EqualTo(1203.1100000000006d));
        }
    }
}